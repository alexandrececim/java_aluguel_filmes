...
public class FilmeDAOImpl implements FilmeDAO {
	...
	public void insert(Connection conn, Filme filme) throws Exception {
        ...
        myStmt.setDate(2, (java.sql.Date) filme.getDataLancamento());
	...
	public void edit(Connection conn, Filme filme) throws Exception {
		PreparedStatement myStmt = conn.prepareStatement("update en_filme set data_lancamento = (?), "
				+ "nome = (?), descricao = (?) where id_filme = (?)");

		
        myStmt.setDate(1, (java.sql.Date) filme.getDataLancamento());
